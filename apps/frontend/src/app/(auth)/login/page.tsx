...
function LoginForm() {
  ...
  return (
    <main className="maths-symbols relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-950 px-4 py-10 text-slate-50">
      <div aria-hidden="true" className="pointer-events-none absolute left-[10%] top-20 hidden text-8xl font-black text-cyan-500/10 lg:block">√</div>
      <div aria-hidden="true" className="pointer-events-none absolute bottom-20 right-[10%] hidden text-8xl font-black text-violet-400/10 lg:block">∞</div>
      <div className="relative w-full max-w-md rounded-[2rem] border border-cyan-400/30 bg-slate-900/95 p-6 shadow-2xl shadow-cyan-950/30 backdrop-blur md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <button type="submit" disabled={isSubmitting || loading} className="flex w-full items-center justify-center rounded-xl bg-cyan-500 px-4 py-3 text-base font-semibold text-slate-950 shadow-lg shadow-cyan-950/20 transition hover:bg-cyan-400 disabled:cursor-not-allowed disabled:bg-cyan-500/60">
